...
class Docstrum:
    ...
    def merge_overlapping_blocks(self, components: List[Component], blocks: List[List[List[int]]], 
                                ...
                                alignment_threshold: float = 0.25) -> List[List[List[int]]]:
        """
        Merge blocks that overlap horizontally or vertically with similar alignments
...
def main():
    ...
    parser.add_argument('--k_nearest', type=int, default=6, 
                       help='Number of nearest neighbors (default: 6)')

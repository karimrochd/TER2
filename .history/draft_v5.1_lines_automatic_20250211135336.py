...
class Docstrum:
    ...
    def preprocess(self, image: np.ndarray) -> np.ndarray:#, small_components_threshold = 7) -> np.ndarray:
        """
    ...
    def find_connected_components(self, binary: np.ndarray, big_components_threshold : int) -> List[Component]:
        ...
        for i in range(1, num_labels):
            ...
            # if not big_components_threshold == -1 and area > big_components_threshold:
            #     continue

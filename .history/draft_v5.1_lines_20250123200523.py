...
def calculate_distance_thresholds(components: List[Component]) -> Tuple[float, float]:
    ...
    if horizontal_gaps:
        ...
        horizontal_threshold = horizontal_q75 + 2.25 * horizontal_iqr
        # Cap the threshold to a reasonable multiple of median width
        horizontal_threshold = min(horizontal_threshold, median_width * 6)
    else:
    ...
    if vertical_gaps:
        ...
        vertical_threshold = vertical_q75 + 1.75 * vertical_iqr

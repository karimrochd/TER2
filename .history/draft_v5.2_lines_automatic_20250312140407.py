...
class Docstrum:
    ...
    def preprocess(self, image: np.ndarray, small_component_threshold = 7, binarization_threshold = -1, kfill_threshold = 5) -> np.ndarray:
        """
        ...
        binary = remove_small_components(binary, small_component_threshold= small_component_threshold, kfill_threshold = kfill_threshold)
...
def process_and_save_visualization(image: np.ndarray, output_dir: str, filename: str, 
    ...
    binary = docstrum.preprocess(image, small_component_threshold=small_component_threshold, binarization_threshold = binarization_threshold, kfill_threshold = kfill_threshold)

...
def main():
    ...
    parser.add_argument('--corner_threshold', type=float, default=15,
                       help='Maximum distance between corners to consider them as sharing a border (default: 15)')
    parser.add_argument('--horizontal_distance_threshold', type=float, default=50,
                       help='Maximum horizontal distance between blocks to merge them (default: 50)')
    parser.add_argument('--vertical_distance_threshold', type=float, default=50,
                       help='Maximum vertical distance between blocks to merge them (default: 50)')
    parser.add_argument('--just_lines', action='store_true', default=True,
                       help='If True, only merge blocks in the same line (default: True)')

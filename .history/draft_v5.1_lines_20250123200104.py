...
def calculate_distance_thresholds(components: List[Component]) -> Tuple[float, float]:
    ...
    if horizontal_gaps:
        ...
        horizontal_threshold = horizontal_q75 + 2.0 * horizontal_iqr
        # Cap the threshold to a reasonable multiple of median width
        horizontal_threshold = min(horizontal_threshold, median_width * 5)
    else:
    ...
    if vertical_gaps:
        ...
        vertical_threshold = min(vertical_threshold, median_height * 4)
    else:

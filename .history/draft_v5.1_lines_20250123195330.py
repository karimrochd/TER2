...
def calculate_distance_thresholds(components: List[Component]) -> Tuple[float, float]:
    ...
    if horizontal_gaps:
        ...
        horizontal_threshold = horizontal_q75 + 1.5 * horizontal_iqr
        # Cap the threshold to a reasonable multiple of median width
        horizontal_threshold = min(horizontal_threshold, median_width * 3)
    else:
    ...
    if vertical_gaps:
        ...
        vertical_threshold = vertical_q75 + 1.5 * vertical_iqr
        # Cap the threshold to a reasonable multiple of median height
        vertical_threshold = min(vertical_threshold, median_height * 2)
    else:

...
class Docstrum:
    ...
    # def process(self, image: np.ndarray, spacing_factor: float = 1.2, visualize: bool = True) -> Tuple[List[Component], List[List[int]], float]:
    #     """
...
#     # Add new spacing_factor argument
...
#                 image, args.output_dir, filename, docstrum, args.spacing_factor
#             )
...
#                 try:
#                     components, text_lines, orientation, blocks = process_and_save_visualization(
#                         image, args.output_dir, base_filename, docstrum, args.spacing_factor
#                     )
#                     print(f"Processed {filename}:")
#                     print(f"- Found {len(components)} components")
#                     print(f"- Grouped into {len(text_lines)} text lines")
...
def main():
    ...
    parser.add_argument('--spacing_factor', type=float, default=1.2,
                       help='Factor to multiply local intercharacter space for max allowed gap (default: 1.2)')
    parser.add_argument('--corner_threshold', type=float, default=20,

...
def remove_small_components(binary_image, small_component_threshold = 7, kfill_threshold = 5, filter_type = 2):
    """
    ...
    if filter_type == 0 or filter_type == 2:
        ...
        binary_image = kfill(binary_image, k=kfill_threshold, max_iterations=10)
...
class Docstrum:
    ...
    def preprocess(self, image: np.ndarray, small_component_threshold = 7, binarization_threshold = -1, kfill_threshold = 5, filter_type = 2) -> np.ndarray:
        """
        ...
        binary = remove_small_components(binary, small_component_threshold= small_component_threshold, kfill_threshold = kfill_threshold, filter_type = filter_type)
...
def process_and_save_visualization(image: np.ndarray, output_dir: str, filename: str, 
    ...
    binary = docstrum.preprocess(image, small_component_threshold=small_component_threshold, binarization_threshold = binarization_threshold, kfill_threshold = kfill_threshold, filter_type = filter_type)
